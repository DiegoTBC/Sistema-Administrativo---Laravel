...
Route::middleware('auth')->group(function(){
    ...
    Route::resource('movimentos-financeiros', 'MovimentosFinanceirosController')->except([
        'edit', 'update'
    ]);
    Route::post('empresas/buscar-por/nome', 'Selects\EmpresaNomeTipo');
    Route::get('empresas/relatorios/saldo/{empresa}', 'Relatorio\SaldoEmpresa')->name('empresas.relatorios.saldo');
