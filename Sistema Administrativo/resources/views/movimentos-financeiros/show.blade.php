                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Descricao </th><td> {{ $movimentosfinanceiro->descricao }} </td></tr><tr><th> Valor </th><td> {{ $movimentosfinanceiro->valor }} </td></tr><tr><th> Data </th><td> {{ $movimentosfinanceiro->data }} </td></tr>
                                </tbody>
                            </table>
                        </div>
